        ...
        <ThemedView style={styles.container}>
            ...
            >
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <FullButton text='Continue' onPress={() => { router.push('/checkout/payment') }} style={{ marginTop: 20, flex: 1 }} />
                </ScrollView>
            </KeyboardAvoidingView>
